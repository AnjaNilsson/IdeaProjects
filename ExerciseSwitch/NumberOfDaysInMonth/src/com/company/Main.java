...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println(isLeapYear(-1600));          //should return false since parameter is not in the range (1-9999)
        System.out.println(isLeapYear(1600));           //should return true since 1600 is leap year
        ...
        //should return 31 since January has 31 days.getDaysInMonth(2, 2020);
