...
sumFirstAndLastDigit(0); should return 0, first digit and the last digit is 0, since we only have 1 digit, which gives
                         us 0+0 and the sum is 0.
sumFirstAndLastDigit(5); should return 10, first digit and last digit is 5, since we only have 1 digit, which gives us
                         5+5 and the sum is 10.
