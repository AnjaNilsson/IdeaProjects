...
The method should return boolean and it needs to return true if sum of first and second parameter is equal
to third parameter. Otherwise return false.
...
public class Main {
    ...
    public static boolean hasEqualSum (int firstValue, int secondValue, int thirdValue) {
        int sumOfFirstAndSecond = firstValue + secondValue;
        if (sumOfFirstAndSecond == thirdValue) {
            return true;
        } else {
            return false;
        }
