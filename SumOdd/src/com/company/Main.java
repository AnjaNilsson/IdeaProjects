...
Write a second method called sumOdd that has 2 int parameters start and end, which represent a range
of numbers.
...
If those are not satisfied return -1 from the method to indicate invalid input.
